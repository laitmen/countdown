class WeatherSimulator {
    ...
    getBaseTemperature(season, timeOfDay) {
        const baseTemps = {
            winter: { morning: -2, afternoon: 3, evening: -1, night: -5 },
            spring: { morning: 6, afternoon: 12, evening: 7, night: 4 },
            summer: { morning: 12, afternoon: 18, evening: 13, night: 10 },
            autumn: { morning: 7, afternoon: 11, evening: 6, night: 3 }
        };
        
        return (baseTemps[season] && baseTemps[season][timeOfDay]) || 10;
    }
    ...
    getWeatherProbabilities(season) {
        ...
        return probabilities[season] || probabilities['spring'];
    }
    ...
    getWeatherDescription(condition) {
        ...
        return descriptions[condition] || "Variabile";
    }
    ...
    updateWeatherDisplay() {
        ...
        // Aggiorna sfondo (id #dynamic-background)
        const backgroundElement = document.getElementById('dynamic-background');
        if (backgroundElement) {
            backgroundElement.className = ''; // reset
            backgroundElement.classList.add(weatherClass);
        }
        ...
        if (typeof initParticles === 'function') {
            try {
                ...
                console.warn('Errore initParticles', e);
            }
        }
        ...
        targetDateElement.innerHTML = `
            ...
            <div class="date-info">
                ${this.location} • 2 Novembre 2025, 14:30
            </div>
        `;
    }
...
// Inizializza simulatore meteo in modo che sia disponibile globalmente
